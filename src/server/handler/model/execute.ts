import { createGitHubClient } from "../../../github/client/api/create-github-client";
import type { GitHubClient } from "../../../github/client/model/types";
import { isTrustedAssociation } from "../../../github/event/lib/actor";
import type { Trigger } from "../../../github/event/model/types";
import { createLlmClient } from "../../../llm/api/client";
import { log } from "../../../logger";
import { renderError } from "../../../review/render/lib/error";
import { runReview } from "../../../review/runner/model/run-review";
import type { RunnerDeps } from "../../../review/runner/model/types";
import { answerThread } from "../../../review/thread/model/answer-thread";
